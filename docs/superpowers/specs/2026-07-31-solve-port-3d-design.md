...
| Actuator: permittivity channel | LANDED in 2-D (commit 890dc22): census 13/18 -> 17/18 vs best stored masks. STATUS UPGRADED 2026-08-01 (GRAPHITE_VS_CB_DIELECTRIC_MEMO.md, commit 984d36c): "PHYSICALLY EXPECTED, LAW UNCALIBRATED" - near-percolation eps divergence is established for carbon fillers in this frequency class, and Allison's own graphite data (eps_r 4 to 240 over 10-60 wt%) contradicts fixed-eps; the pinned eps_r=20 fixed-value model is the STRONGER unphysical assumption, not the eps channel. Still NOT DEPLOYABLE until the M2 impedance measurement (INK_DOPANT_CALIBRATION_BRIEF.md) supplies the dose co-variation law and the true baseline (published 13.8 vs pinned 20) | add dJ/d-eps_r in dolfinx (cheap: complex-symmetric A^H = conj(A) reuse), badged "physically expected, law uncalibrated"; do not present eps-channel maps as printable until M2 lands - the 2-D evidence says this channel decides shapes (their cross: J 343 with eps vs 1036 without) |
